...
#main variables
API_ID = int(environ.get('API_ID', '8031189962'))
API_HASH = environ.get('API_HASH', '67d3ec64db8031189962b5d4804884c0')
BOT_TOKEN = environ.get('BOT_TOKEN', '7719153689:AAHTIWrldYnbbNOa2xD0O4ojZq08Xh1fdyk')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7140699364').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/moviefastss")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002530980008').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://seiamvai91:seiamvai91@cluster0.aeb0fw4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
